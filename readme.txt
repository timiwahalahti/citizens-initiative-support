...
Donate link: 
Tags: finnish, citizen initiative, support, support statement, widget, sidebar, aloite, kansalaisaloite
...
Adds a widget to display number of support statements in defined Finnish citizen initiative.

== Description ==
This plugin provides easy way for adding widget to show number of support statements in Finnish citizen initiative. It also adds a link to kansalaisaloite.fi where the initiative may be signed. It receives initiative information from kansalaisaloite.fi Open Data API so all the information is fresh.

Plugin handles citizen initiative states correctly.
...
Citizen initiative sent to Parliament will show message saying that the initiative has been sent to Parliament and signature link will not be shown.
...
2. Select `kansalaisaloite.zip` from your computer
3. Upload
4. Activate the plugin on the WordPress Plugin Dashboard

= Using FTP =
1. Extract `kansalaisaloite.zip` to your computer
2. Upload the kansalaisaloite directory to your wp-content/plugins directory
