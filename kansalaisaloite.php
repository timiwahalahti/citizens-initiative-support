<?php
/**
 * Plugin Name: Citizen initiative support
 * Plugin URI: http://kansalaisaloite.fi
 * Description: Adds a widget that displays number of support statements in defined Finnish citizen initiative. Plugin is not service by Finnish Ministry of Justice.
 * Version: 1.0
...
class kacount extends WP_Widget {
	...
	function kacount() {
		/* Widget settings */
		$widget_ops = array( 'classname' => 'kacount', 'description' => __('Displays amount of support statements in defined Finnish citizen initiative', 'kansalaisaloite') );
